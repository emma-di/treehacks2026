              ...
              <div className="flex gap-6 mt-2 text-sm text-gray-600">
                ...
                <span>
                  ...
                  {selectedPatient.provider !== 'TBD' ? (
                    <Link 
                      to={`/provider?id=${findProviderByName(selectedPatient.provider)}`}
                      className="text-blue-600 hover:underline cursor-pointer"
                    >
          ...
          <div className="mb-6 bg-gray-50 rounded-lg p-4 border border-gray-200">
            ...
            <div className="flex items-center gap-3 mb-4">
              ...
              <span className={`px-3 py-1 rounded-full font-bold ${
                selectedPatient.acuity === 'High' ? 'bg-red-100 text-red-700' :
                ...
                {generatePatientSchedule(selectedPatient.id).map((item, idx) => (
                  <tr key={idx} className="border-b last:border-b-0">
                    ...
                    <td className="pr-3 align-top py-4">
                      <div className={`border-l-4 rounded px-3 py-3 ${
