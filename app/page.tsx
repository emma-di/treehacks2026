...
// Points around the world → all converge to Bay Area
...
const GLOBE_CONFIG: GlobeConfig = {
  ...
  polygonColor: 'rgba(30, 35, 42, 0.95)',
  emissive: '#ffffff',
...
export default function Home() {
  ...
  return (
    <div className="min-h-full flex flex-col bg-gradient-to-b from-slate-50 to-white">
      <style>{`
        .globe-fixed-size {
          width: ${GLOBE_WIDTH}px !important;
          height: ${GLOBE_HEIGHT}px !important;
          min-width: ${GLOBE_WIDTH}px !important;
          min-height: ${GLOBE_HEIGHT}px !important;
          max-width: ${GLOBE_WIDTH}px !important;
          max-height: ${GLOBE_HEIGHT}px !important;
      ...
      <div className="flex-1 flex p-8 items-center justify-center">
        ...
        <div className="flex flex-col items-center flex-shrink-0">
          <div
            className="globe-fixed-size transition-transform duration-300 ease-out hover:scale-[1.02]"
            style={{
              width: GLOBE_WIDTH,
              height: GLOBE_HEIGHT,
